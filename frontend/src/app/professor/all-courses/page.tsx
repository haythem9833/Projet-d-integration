...
const CATEGORIES = ["Development", "Data Science", "Design", "Business", "Marketing", "Cloud", "Mobile"];
    ...
    <DashboardLayout sidebarItems={sidebarItems}>
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-2">Browse all available courses on the platform</p>
        </div>
              ...
              <Card key={course.id} className="hover:shadow-lg transition-shadow bg-white border-gray-200">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <Link href={`/professor/courses/${course.id}`} className="block">
