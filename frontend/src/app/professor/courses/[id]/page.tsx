  ...
  useEffect(() => {
    const fetchCourse = async () => {
      try {
        ...
        if (data.trainer && user) {
          setIsOwnCourse(data.trainer.id === user.id);
        }
      } catch (err) {
    ...
    <DashboardLayout sidebarItems={sidebarItems}>
      <div className="space-y-8">
        ...
        <div className="flex justify-between items-start">
          <div>
            <Link href="/professor/courses" className="text-green-600 hover:text-green-700 text-sm font-medium mb-2 inline-block">
              ← Back to My Courses
            </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          ...
          <Card className="bg-white border-gray-200">
            <CardHeader>
              <CardTitle className="text-gray-900 text-sm">Price</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-2xl font-bold text-blue-600">${course.price || 0}</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white border-gray-200">
            ...
            <CardContent>
              <p className="text-2xl font-bold text-purple-600">{course.modules?.length || 0}</p>
            </CardContent>
          </Card>

          <Card className="bg-white border-gray-200">
            <CardHeader>
              <CardTitle className="text-gray-900 text-sm">Quizzes</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        {course.trainer && (
          <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
            <CardHeader>
              <CardTitle className="text-gray-900">👨‍🏫 Instructor Information</CardTitle>
            </CardHeader>
            <CardContent>
                ...
                <Card key={module.id} className="bg-white border-gray-200 hover:shadow-md transition-shadow">
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-2">
                      <p
                        className="text-sm text-gray-600 cursor-pointer select-none hover:text-gray-900 font-medium"
                        onClick={() =>
                      ...
                      >
                        ...
                        lessons {openModuleId === module.id ? "▲" : "▼"}
                      </p>
                      ...
                      {module.quiz && openModuleId === module.id && (
                        <div className="mt-4 p-3 bg-orange-50 rounded-lg border border-orange-200">
                          <p className="text-sm font-semibold text-orange-900">📝 Module Quiz</p>
                          <p className="text-sm text-orange-800 mt-1">{module.quiz.title}</p>
